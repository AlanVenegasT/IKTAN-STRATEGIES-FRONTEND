    ...
    <div className="relative overflow-hidden bg-white py-16">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-prose text-lg">
          <h1> 
            <span className="mt-2 mb-12 block text-center text-3xl font-bold leading-8 tracking-tight text-gray-900 sm:text-4xl">
              Politicas de Privacidad
            </span>
          </h1>
        </div>
        <div className="prose prose-lg prose-indigo ml-96 mr-96 mt-6 text-gray-500 text-justify">
          ...
          sus datos personales y los terceros con los que la compartiremos. <b>IKTAN Strategies S.A.P.I DE C.V </b> (en lo sucesivo <b>IKTAN Strategies</b>) informa, mediante el presente Aviso de
          ...
          <ul className='list-inside text-base text-gray-500 list-decimal'>
          ...
          Vigente a: Mon Dec 12 2022
          </p>

          <div className='absolute right-96'>
          <button type="button"className="mr-8 inline-flex items-center px-5 py-2 border border-transparent text-base font-medium rounded-full shadow-sm text-white bg-[#DD102A]  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
          Enterado
          </button>
          </div>
